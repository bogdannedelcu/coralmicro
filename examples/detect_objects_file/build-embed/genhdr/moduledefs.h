...
extern const struct _mp_obj_module_t mp_module_coral;
#undef MODULE_DEF_CORAL
#define MODULE_DEF_CORAL { MP_ROM_QSTR(MP_QSTR_coral), MP_ROM_PTR(&mp_module_coral) },
