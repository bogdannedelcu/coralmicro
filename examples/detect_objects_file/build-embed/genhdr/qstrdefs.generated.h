...
QDEF1(MP_QSTR_cam_init, 51375, 8, "cam_init")
QDEF1(MP_QSTR_cam_jpeg, 21005, 8, "cam_jpeg")
QDEF1(MP_QSTR_cam_native_res, 28111, 14, "cam_native_res")
QDEF1(MP_QSTR_cam_res, 18641, 7, "cam_res")
QDEF1(MP_QSTR_cam_save_jpeg, 26227, 13, "cam_save_jpeg")
QDEF1(MP_QSTR_cam_set_res, 44716, 11, "cam_set_res")
QDEF1(MP_QSTR_cam_stop, 58669, 8, "cam_stop")
QDEF1(MP_QSTR_cam_switch, 51271, 10, "cam_switch")
QDEF1(MP_QSTR_cam_to_tensor, 47040, 13, "cam_to_tensor")
QDEF1(MP_QSTR_closure, 51828, 7, "closure")
QDEF1(MP_QSTR_collect, 26011, 7, "collect")
QDEF1(MP_QSTR_coral, 21142, 5, "coral")
...
QDEF1(MP_QSTR_fs_mkdir, 63702, 8, "fs_mkdir")
QDEF1(MP_QSTR_fs_read, 7997, 7, "fs_read")
QDEF1(MP_QSTR_fs_read_base64, 24565, 14, "fs_read_base64")
QDEF1(MP_QSTR_fs_read_str, 16695, 11, "fs_read_str")
QDEF1(MP_QSTR_fs_remove, 42857, 9, "fs_remove")
QDEF1(MP_QSTR_fs_size, 43562, 7, "fs_size")
...
QDEF1(MP_QSTR_get_output, 48851, 10, "get_output")
QDEF1(MP_QSTR_get_row, 38086, 7, "get_row")
QDEF1(MP_QSTR_get_val, 34071, 7, "get_val")
...
QDEF1(MP_QSTR_usb_drive, 114, 9, "usb_drive")
