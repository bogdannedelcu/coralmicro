// AUTO-GENERATED from third_party/h3/src/h3lib/include/h3api.h.in
// DO NOT EDIT — re-generate with the sed command in build_and_run.sh
// (only 3 version-macro substitutions: H3_VERSION_MAJOR/MINOR/PATCH)
