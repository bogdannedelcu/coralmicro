...
def run():
    ...
    if rc == 0 and sentai.tfl.input_size() == 1:
        # hello_world.tflite in TFLM is int8; x=0.0 maps to zero-point -128.
        text += _line("set_input_rc", sentai.tfl.set_input(bytes((128,))))
