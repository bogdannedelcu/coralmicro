"""s189 verdict -- OP-S10-W21-T3 Kp persist round-trip PASS gate."""
...
def main(log_path: str) -> int:
    ...
    pat = re.compile(r"\[s189\] T(\d+) (PASS|FAIL) (.+)$", re.MULTILINE)
    ...
    overall_pass = "[s189] OVERALL PASS" in log
    overall_fail = "[s189] OVERALL FAIL" in log

    print("=" * 60)
    print("s189 verdict -- OP-S10-W21-T3 Kp persist round-trip")
    print("=" * 60)
