...
extern const struct _mp_obj_module_t mp_module_sentai;
#undef MODULE_DEF_SENTAI
#define MODULE_DEF_SENTAI { MP_ROM_QSTR(MP_QSTR_sentai), MP_ROM_PTR(&mp_module_sentai) },
