...
QDEF1(MP_QSTR_age, 13030, 3, "age")
QDEF1(MP_QSTR_alarm_type, 11537, 10, "alarm_type")
QDEF1(MP_QSTR_alt, 13148, 3, "alt")
QDEF1(MP_QSTR_altitude_cm, 38436, 11, "altitude_cm")
QDEF1(MP_QSTR_active_camera, 5135, 13, "active_camera")
...
QDEF1(MP_QSTR_camera_id, 53621, 9, "camera_id")
QDEF1(MP_QSTR_camera_lat, 16782, 10, "camera_lat")
QDEF1(MP_QSTR_camera_lon, 19279, 10, "camera_lon")
QDEF1(MP_QSTR_ceil, 45062, 4, "ceil")
QDEF1(MP_QSTR_channel, 37158, 7, "channel")
QDEF1(MP_QSTR_class_id, 34873, 8, "class_id")
QDEF1(MP_QSTR_dist_cm, 51793, 7, "dist_cm")
...
QDEF1(MP_QSTR_conf, 55585, 4, "conf")
...
QDEF1(MP_QSTR_embed_crc8, 43291, 10, "embed_crc8")
...
QDEF1(MP_QSTR_gx_cm, 22589, 5, "gx_cm")
QDEF1(MP_QSTR_gy_cm, 23068, 5, "gy_cm")
QDEF1(MP_QSTR_h, 46541, 1, "h")
QDEF1(MP_QSTR_hdg, 20558, 3, "hdg")
QDEF1(MP_QSTR_heading_deg, 35092, 11, "heading_deg")
...
QDEF1(MP_QSTR_last_gx_cm, 47021, 10, "last_gx_cm")
QDEF1(MP_QSTR_last_gy_cm, 47490, 10, "last_gy_cm")
QDEF1(MP_QSTR_last_lat, 50125, 8, "last_lat")
QDEF1(MP_QSTR_last_lon, 50132, 8, "last_lon")
...
QDEF1(MP_QSTR_pitch_deg, 7098, 9, "pitch_deg")
...
QDEF1(MP_QSTR_reason, 51523, 6, "reason")
QDEF1(MP_QSTR_receive, 46414, 7, "receive")
QDEF1(MP_QSTR_receive_vision, 34005, 14, "receive_vision")
...
QDEF1(MP_QSTR_roll_deg, 20001, 8, "roll_deg")
...
QDEF1(MP_QSTR_send_delete, 46244, 11, "send_delete")
QDEF1(MP_QSTR_send_update, 48631, 11, "send_update")
QDEF1(MP_QSTR_sensor_id, 46273, 9, "sensor_id")
...
QDEF1(MP_QSTR_target_lat, 37589, 10, "target_lat")
QDEF1(MP_QSTR_target_lon, 40086, 10, "target_lon")
