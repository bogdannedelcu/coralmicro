...
# E19 (switch_sync_check) removed 2026-04-21 — switch_sync() was a no-op
# stub (ISR fast-wake path was backed out after hang risk, see
# embeded.md §M).  The experiment had no diagnostic value without it.
# Rationale preserved in paper/camera.md.
