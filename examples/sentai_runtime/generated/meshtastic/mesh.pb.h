...
#if defined(meshtastic_Config_size) && defined(meshtastic_XModem_size) && defined(meshtastic_DeviceUIConfig_size)
union meshtastic_FromRadio_payload_variant_size_union {char f5[(6 + meshtastic_Config_size)]; char f12[(6 + meshtastic_XModem_size)]; char f17[(7 + meshtastic_DeviceUIConfig_size)]; char f0[504];};
#endif
#if defined(meshtastic_XModem_size)
union meshtastic_ToRadio_payload_variant_size_union {char f5[(6 + meshtastic_XModem_size)]; char f0[504];};
#endif
...
#define MESHTASTIC_MESHTASTIC_MESH_PB_H_MAX_SIZE meshtastic_MqttClientProxyMessage_size
...
#endif
#if defined(meshtastic_XModem_size)
#define meshtastic_ToRadio_size                  (0 + sizeof(union meshtastic_ToRadio_payload_variant_size_union))
#endif
