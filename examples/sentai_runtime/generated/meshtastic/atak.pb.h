...
typedef struct _meshtastic_Contact {
    /* Callsign */
    pb_callback_t callsign;
    /* Device callsign */
    pb_callback_t device_callsign; /* IP address of endpoint in integer form (0.0.0.0 default) */
} meshtastic_Contact;
...
#define meshtastic_GeoChat_init_default          {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define meshtastic_Contact_init_default          {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define meshtastic_GeoChat_init_zero             {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Group_init_zero               {_meshtastic_MemberRole_MIN, _meshtastic_Team_MIN}
#define meshtastic_Status_init_zero              {0}
#define meshtastic_Contact_init_zero             {{{NULL}, NULL}, {{NULL}, NULL}}
...
X(a, CALLBACK, ONEOF,    BYTES,    (payload_variant,detail,payload_variant.detail),   7)
...
X(a, CALLBACK, OPTIONAL, STRING,   to,                2) \
X(a, CALLBACK, OPTIONAL, STRING,   to_callsign,       3)
...
X(a, CALLBACK, SINGULAR, STRING,   callsign,          1) \
X(a, CALLBACK, SINGULAR, STRING,   device_callsign,   2)
#define meshtastic_Contact_CALLBACK pb_default_field_callback
...
/* meshtastic_Contact_size depends on runtime parameters */
#define MESHTASTIC_MESHTASTIC_ATAK_PB_H_MAX_SIZE meshtastic_PLI_size
#define meshtastic_Group_size                    4
#define meshtastic_PLI_size                      33
#define meshtastic_Status_size                   6
