...
#if defined(meshtastic_DeviceUIConfig_size)
union meshtastic_Config_payload_variant_size_union {char f10[(6 + meshtastic_DeviceUIConfig_size)]; char f0[207];};
#endif
#if defined(meshtastic_DeviceUIConfig_size)
#define meshtastic_Config_size                   (0 + sizeof(union meshtastic_Config_payload_variant_size_union))
#endif
#define MESHTASTIC_MESHTASTIC_CONFIG_PB_H_MAX_SIZE meshtastic_Config_NetworkConfig_size
