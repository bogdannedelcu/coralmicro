...
// We use 4 — empirically necessary because our integer-pixel contour
// extractor produces noisier bit patterns than cv2's float-precision
// _refineCandidateLines.  False-positive risk mitigated by
// _getBorderErrors gate (T18-O step 1) + _filterTooCloseCandidates
// dedup + downstream VPE id<4 filter.
